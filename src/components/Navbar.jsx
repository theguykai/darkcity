const Navbar = () => {
  return (
    <div>
      <nav className="z-5 flex justify-center content-center p-2">
        <ul className="flex justify-between content-center">
          ...
          <h4 className="my-0 mx-1 py-0 px-2 text-lg font-bold uppercase tracking-tighter border-r-2 border-l-2 border-current">
